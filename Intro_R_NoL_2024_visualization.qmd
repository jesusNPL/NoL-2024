...
**Answer:**
Both MAT and MAP are positively associated with the number of species. However, MAP shows a more steeper association than MAT. Also, MAP (R\^2 = 0.35) explain more variance than MAT (R\^2 = 0.17). 
